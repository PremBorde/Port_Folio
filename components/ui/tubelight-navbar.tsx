...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    <>
      ...
      >
      <nav className="relative flex items-center justify-center p-1 bg-white/[0.03] border border-white/[0.08] backdrop-blur-xl rounded-full shadow-2xl">
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-white/[0.05] border border-white/[0.1] rounded-full -z-10"
                    transition={{
                      type: "spring",
                      stiffness: 400,
                      damping: 30,
                ...
                {!isActive && (
                  <div className="absolute inset-0 bg-white/[0.02] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-20" />
                )}
              </button>
            )
          })}
